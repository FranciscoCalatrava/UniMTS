...
class $DATASET_NAME$():
    ...
    def get_datasets(self):
        ...
        for b in training.keys():
            data = pd.read_csv(self.PATH + f"datasets/{self.dataset_name}/normal/...", sep=' ')
    ...
    def data_segmentation(self):
        train_data_segmented = self.segment_data(self.training_normalized, 66, 33)
        validation_data_segmented = self.segment_data(self.validation_normalized, 66, 33)
        test_data_segmented = self.segment_data(self.test_normalized, 66, 33)
